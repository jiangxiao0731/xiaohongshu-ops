...
- **主动思考，不要等 Shaw 提问。** 每次做决策前先问自己：这个决策依据是什么？有没有更好的依据？有哪些因素我还没考虑？然后再给答案。不要给出没有经过深度思考的机械答案。 做计划时把所有相关问题想全：发帖要不要投流？投多少？什么时候投？自然流量怎么判断？判断标准是什么？每一步的决策依据和备选方案都要提前写清楚，不能只给结论不给逻辑。Shaw 不应该需要追问"为什么"。
