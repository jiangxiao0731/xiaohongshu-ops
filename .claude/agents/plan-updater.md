...
## prompt
Read all performance data from Notion. Analyze trends. Check stage transition criteria (修复期 → 建量期: 72h内 >= 50赞藏 or 聚光CTR >= 3%). Adjust queue-manager weights. Update PLAN-V2.md and CALENDAR.md if needed. Slack summary of changes.
...
5. Apply changes:
   - Update PLAN-V2.md with new stage if transitioning
