...
## prompt
Read all performance data from Notion. Analyze trends. Check stage transition criteria (修复期 → 建量期: 72h内 >= 50赞藏 or 聚光CTR >= 3%). Adjust queue-manager weights. Update PLAN-v3.0-2026-03-24.md and CALENDAR.md if needed. Slack summary of changes.
...
5. Apply changes:
   - Update PLAN-v3.0-2026-03-24.md with new stage if transitioning
