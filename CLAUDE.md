...
- **Full plan:** `PLAN-v4.1-2026-03-29.md` (v4.1, plan review修复: 专业号认证、中间检查点、时间/标签统一)

## Plan Review Discipline

`PLAN-v4.1-2026-03-29.md` is the operational backbone. Follow these rules:

1. **Every session start:** Read `PLAN-v4.1-2026-03-29.md` and `WORKFLOW-STATE.md` to understand current state.
2. **Daily review:** At the end of each working day, review what actions were taken (posts published, designs created, data collected, decisions made). If any posts were published or performance data was read, refine `PLAN-v4.1-2026-03-29.md` accordingly -- adjust timelines, update learnings, shift priorities based on real results.
...
| File | Purpose |
|------|---------|
| `PLAN-v4.1-2026-03-29.md` | Master plan (策略/定位/投流/目标) |
